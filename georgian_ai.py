    ...
    if submit_button:
        if not API_KEY:
            ...
            try:
                ...
                prompts = {
                    "Summary": "შენ ხარ რედაქტორი. შეაჯამე ტექსტი მოკლედ:",
                    "Bullet Points": "გამოყავი ტექსტიდან მნიშვნელოვანი ფაქტები პუნქტებად:",
                    "Critical Analysis": "მოახდინე ტექსტის კრიტიკული ანალიზი:",
                    "Simplified Language": "გადაწერე ეს ტექსტი მარტივი ქართულით:"
                }
